...
avgit = 5; %no. of iterations per set of parameters
nlim = 5; %max pref attachment tested
...
for nlimit = 1:nlim
    for crit = 1:avgit    
        ...
        crarray(nlimit,2) = crarray(nlimit,2) + fmodel1(seed, nodes, nlimit, niter, l, s, a, 'WS');   
    end
...
% load handel;
% sound(y, Fs);
save('crarray_WS_a1_500_10_5.mat', 'crarray');
