...
for nlimit = 1:nlim
  %  p = sqrt(2*nlimit/(nodes*plays));
    for crit = 1:avgit    
        ...
        toc 
        tic
        crarray(nlimit,2) = crarray(nlimit,2) + fmodel1(seed, nodes, nlimit, niter, l, s, a, 'BP', nlimit, 0.032);   
    end
...
% load handel;
% sound(y, Fs);
save('crarray_BP_varyingplays_modaccept_selflisten_500_10_10.mat', 'crarray');
